...
def show():
    ...
    - Chapman, P., Clinton, J., Kerber, R., Khabaza, T., Reinartz, T., Shearer, C., & Wirth, R. (2000). CRISP-DM 1.0: Step-by-step data mining guide. [https://web.archive.org/web/20200912023158/https://www.the-modeling-agency.com/crisp-dm.pdf](https://web.archive.org/web/20200912023158/https://www.the-modeling-agency.com/crisp-dm.pdf)  
    - Davenport, T. H. (2006). Competing on analytics. *Harvard business review, 84(1)*, 98–107, 134. [https://cs.brown.edu/courses/cs295-11/competing.pdf](https://cs.brown.edu/courses/cs295-11/competing.pdf) 
    - De Mauro, A., & Sestino, A. (2022). Machine learning and artificial intelligence use in marketing: A general taxonomy. *Italian Journal of Marketing, 2022(4)*, 439–457. [https://doi.org/10.1007/s43039-022-00057-w](https://doi.org/10.1007/s43039-022-00057-w)  
    ...
    - Javaheri, S. H., Sepehri, M. M., & Teimourpour, B. (2014). Response modeling in direct marketing: A data mining-based approach for target selection. In Y. Zhao & Y. Cen (Eds.),*Data mining applications with R*, (pp. 153-180). Academic Press. [https://doi.org/10.1016/B978-0-12-411511-8.00006-2](https://doi.org/10.1016/B978-0-12-411511-8.00006-2)  
    ...
    - Matter, U. (2023). *Big data analytics: A guide to data science practitioners making the transition to big data*. Chapman and Hall. [https://doi.org/10.1201/9781003378822](https://doi.org/10.1201/9781003378822)  
